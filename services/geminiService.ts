  ...
  try {
    ...
    **กฎการสร้าง aiSearchName (3 ตัวอักษร):**
    ...
    3. **ตัวอักษรที่ 3 (เปอร์เซ็นต์น้ำยา):**
       - '1' สำหรับความเข้มข้น 1.5% (หรือแถบสีเหลือง หรือ ฉลากสีขาว ของ Lucenxia)
       - '2' สำหรับความเข้มข้น 2.5% (หรือแถบสีเขียว ของ Baxter/Vantive หรือ ฉลากสีน้ำเงิน ของ Lucenxia)
       - '4' สำหรับความเข้มข้น 4.25% (หรือแถบสีส้ม หรือ ฉลากสีชมพู ของ Lucenxia)

    ตัวอย่าง: "VC1" (Vantive, CAPD 2000ml, 1.5%), "FA2" (Fresenius, APD 5000ml, 2.5%)

    **กฎการวิเคราะห์จากสี (Color Guide):**
    1. แถบสีส้ม (Orange) หรือ ฉลากสีชมพู (Pink - Lucenxia): 4.25%
    2. แถบสีเขียว (Green) หรือ ฉลากสีน้ำเงิน (Blue - Lucenxia): 2.5% (หรือ 2.3% ให้ปัดเป็น '2')
    3. แถบสีเหลือง (Yellow) หรือ ฉลากสีขาว (White - Lucenxia): 1.5%
